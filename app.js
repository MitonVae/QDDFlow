...
function renderStepsList() {
  ...
  STATE.steps.forEach((step, i) => {
    ...
    item.className = 'step-item' + (STATE.activeStepId === step.id ? ' active' : '');
    ...
    item.addEventListener('click', e => {
      ...
      renderStepsList();
      // Navigate: scroll the preview area to show this step's header
...
function addStep() {
  const newStep = {
    id: genId(), name: '新环节', trigger: '', location: '',
    characters: '', desc: '', imageUrl: '', images: [], color: '', customFields: [], taskType: ''
  };
